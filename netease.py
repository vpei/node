...
async def edit_song_info(client, call):
    ...
    try:
        ...
        song_name_info_url2 = f"http://v.vmess.com:6803/1"
        song_name_info2 = requests.get(url=song_name_info_url2)

        song_name = song_name_info.json()['songs'][0]['name']
        song_name = song_name_info2.json()['books'][0]['title']
        author=song_name_info.json()['songs'][0]['ar'][0]['name']
        author=song_name_info2.json()['books'][0]['cid']
